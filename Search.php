                                ...
                                <script>
                                    ...
                                    ?>
                                        for (let h = 0; h < 1; h++) {
                                            ...
                                            tr.innerHTML = '<td style="text-align: center; width: 5%;"> <?= $num?></td><td> <a href="/Диплом_Рома/student.php?id=<?=$row["id_Students"]?>" style="padding-top: 1%;padding-bottom: 1%;padding-right: 50%;color: #777;"><?=$row["fullname"]?></a></td><td style="text-align: center; width: 10%;"> <?=$row["groups"]?></td>';
                                            elemp.append(tr);
                                            break;
                                        }
                                    <?php
