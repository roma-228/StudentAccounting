                                ...
                                <script>
                                    ...
                                    ?>
                                        for (let h = 0; h < 1; h++) {
                                            ...
                                            tr.innerHTML = '<td style="text-align: center;"> <input type="checkbox" name="student" value="<?= $row["id_Students"] ?>" checked></td>  <td>  <a href="/Диплом_Рома/student.php?id=<?= $row["id_Students"] ?>" style="padding-top: 1%;padding-bottom: 1%;padding-right: 50%;color: #777;"><?= $row["fullname"] ?></a></td> ';
                                            elemp.append(tr);
                                            break;
                                        }
                                    <?php
                                ...
                                <div class="mb-md" style="text-align: right;">
                                    <select name="select" id="sel">
                                        <script>
                                            ...
                                            $Student7 = $connect->query("SELECT * FROM `groups` WHERE  `id_ group`!=12 and `id_ group`!=13");
