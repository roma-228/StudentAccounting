					...
					<script>
						...
						?>
							for (let h = 0; h < 5; h++) {
								...
								let form = document.createElement('form');
								div.innerHTML = '<button style="border:none; background: none; color: fff;" class="col-md-12 col-lg-12 col-xl-6"><section class="panel panel-featured-left panel-featured-primary"><div class="panel-body"><div class="widget-summary"><div class="widget-summary-col widget-summary-col-icon"><div class="summary-icon bg-primary style" style="    background: <?= $row["Color"] ?>;"><i style="font-family: Times new Roman;font-style: normal;font-weight: 600;font-size: 50px;"><?= $row["id_kurse"] ?></i></div></div><div class="widget-summary-col"><div class="summary"><h4 class="title" style="font-size:30px;    padding-bottom: 2%; "><?= $row["name"] ?></h4><div class="info"><strong class="amount" style="font-weight: 400;font-size: 20px;">Всього студентів на курсі : <?= $count ?> ос.</strong></div></div></div></div></div></section><input type="hidden" name="perem" value="<?= $row["id_ group"] ?>"></button>';
								form.setAttribute("method", "GET");
