    ...
    <section class="body">
                    ...
                    <div class="panel-body">
                        ...
                        <table class="table table-bordered table-striped mb-none">
                            ...
                            <tbody id="Table">
                                ...
                                <script>
                                    <?php
                                    $Student = $connect->query("SELECT t.`id_ group`, t.`name`,tn.`name` as 'nameSub',tn.`id_Subjects`,tn.`hour`,tn.`ESTS`,tn.`Teacher`,tn.`id_semestr` FROM `groups`t, `subjects`tn WHERE t.`id_kurse`=3 and t.`id_ group`=tn.`id_ group` ORDER BY `id_semestr`");
                                    $num = 1;
        ...
        <script>
            window.onload = function() {
                ...
                <?php
                $Studentt1 = $connect->query("SELECT t.`id_ group`, t.`name`,tn.`name` as 'nameSub',tn.`id_Subjects`,tn.`hour`,tn.`ESTS`,tn.`Teacher`,tn.`id_semestr` FROM `groups`t, `subjects`tn WHERE t.`id_kurse`=3 and t.`id_ group`=tn.`id_ group` ORDER BY `id_semestr`");
            ...
            function save(id) {
                ...
                if (semestr == 5 || semestr == 6) {
                    ...
                    alert("Семестр повинен бути або 5 або 6, відповідно до курсу");
                }
            }
