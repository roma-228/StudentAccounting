                                ...
                                <script>
                                    ...
                                    ?>
                                        for (let h = 0; h < 1; h++) {
                                            ...
                                            tr.innerHTML = '<td style="text-align: center; width: 5%;"> <?= $num?></td><td> <a href="/Диплом_Рома/student.php?id=<?=$row["id_Students"]?>" style="padding-top: 1%;padding-bottom: 1%;padding-right: 50%;color: #777;"><?=$row["fullname"]?></a></td><td class="actions" style="text-align: center;"><i class="fa fa-trash-o" onclick = "trach(<?= $row["id_Students"] ?>)"></i> </td>';
                                            elemp.append(tr);
                                            break;
                                        }
                                    <?php
                        ...
                        <div class="row" style="padding-top: 2%;">
                            <div class="col-sm-6" style="width: 100%;">
                                <div class="mb-md" style="text-align: right;">
                                    <a href="/Диплом_Рома/Transfer.php?perem=<?=$kursePerem?>" class="btn btn-primary">Перевести групу на інший курс <i class="fa fa-cog fa-spin fa-1x fa-fw"></i></a>
                                    <a href="/Диплом_Рома/addstudent.php" class="btn btn-primary">Додати нового студента <i class="fa fa-plus"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
